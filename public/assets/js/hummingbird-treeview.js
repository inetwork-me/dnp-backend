(function($){
	...
	$.each(vals, function(i,e){
		...
		this_checkbox.parent("label").parent("li").find('input:checkbox').prop("disabled",false).prop("checked",state).parent("label").css({'color':textcolor,"cursor":"pointer","height":"15px;"});
	    } else {
	...
	$(dialog + " #" + search_button).on("click", function(e) {
		...
		e.preventDefault();
			...
			this_var_checkbox.parent("label").css({'color':'black',"cursor":"pointer","height":"15px;"});
		    }
	    	}
