        	...
        	<tr>
        		...
        		<td class="text-right">
					...
					@if($page->type == 'custom_page' && auth()->user()->can('delete_website_page'))
          				...
          				<a href="{{ route('custom-pages.sectionCreate',$page->id) }}" class="btn btn-primary btn-sm">
          					<i class="las la-plus"></i> {{ translate('Add Section') }}
          				</a>
          				<a href="{{ route('custom-pages.sections',$page->id) }}" class="btn btn-primary btn-sm">
          					<i class="las la-list"></i> {{ translate('Sections') }}
          				</a>
					@endif
        		</td>
        	</tr>
