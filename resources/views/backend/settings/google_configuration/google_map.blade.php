                        ...
                        <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10" id="">
                                    ...
                                    <input type="text" class="form-control mb-3" id="latitude" name="google_map_latitude" value="{{ get_setting('google_map_latitude') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-2" id="">
                                ...
                                <div class="col-md-10" id="">
                                    ...
                                    <input type="text" class="form-control mb-3" id="longitude" name="google_map_longtitude" value="{{ get_setting('google_map_longtitude') }}">
                                </div>
                            </div>
