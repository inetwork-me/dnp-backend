...
@section('css')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/line-awesome/1.3.0/line-awesome/css/line-awesome.min.css" integrity="sha512-xXYt9OnpYjeUX9oLw+nRVjzdkETWbSL7jBaPfTTtu1Udu7ob8tzNZp8o1cFwEepfWZBAsg4nJALimM6ygE5xDA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
@endsection
...
@section('content')
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center w-100">
                <h5 class="card-title mb-0">{{ translate('Media Library') }}</h5>
                <a href="{{ route('uploaded-files.create') }}" class="btn btn-outline-secondary btn-sm table-button">
    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center w-100">
                <h5 class="card-title mb-0">{{ translate('All files') }}</h5>
        ...
        <div class="card-body">
            <form id="sort_uploads" action="" class="p-4">
