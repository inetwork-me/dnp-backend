...
@section('title')
    {{ translate('Frontend Translation').' - '.$language->name.' '.translate('Language') }}
@endsection
    ...
    <div class="card">
        <div class="card-header row gutters-5">
         <div class="col text-center text-md-left">
           <h5 class="mb-md-0 h6">{{ translate('Frontend Translation').' - '.$language->name.' '.translate('Language') }}</h5>
         </div>
         <div class="col-md-4">
        ...
        <form class="form-horizontal" action="{{ route('app-translations.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-0 text-right d-flex gap-20">
