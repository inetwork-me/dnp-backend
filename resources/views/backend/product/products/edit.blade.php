            ...
            <form action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="tab-content">
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                    ...
                                    {{-- <div class="col-xxl-5 col-xl-6">
                                        <div class="card @if($errors->has('category_ids') || $errors->has('category_id')) border border-danger @endif">
                                            <div class="card-header">
                                                <h5 class="mb-0 h6">{{ translate('Update Product Category') }}</h5>
                                            ...
                                            <div class="card-body">
                                                <label for="category_id">{{ translate('Select a Category') }}</label>
                                                <select class="form-control select2" name="category_id" id="category_id">
                                                    ...
                                                    @foreach ($categories as $category)
                                                        ...
                                                        @foreach ($category->childrenCategories as $childCategory)
                                                            @include('backend.product.products.child_category_dropdown_update', [
                                                                'child_category' => $childCategory, 
                                                                'prefix' => '-', 
                                                                'selected_id' => $product->category_id
                                                            ])
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea class="form-control" required name="description">{{ $product->getTranslation('description', $lang) }}</textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="files_and_media" role="tabpanel" aria-labelledby="files-and-media-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Specifications Images')}} <small>(600x600)</small></label>
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                            ...
                                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                            <input type="hidden" name="specification_images" value="{{ $product->specification_images }}" class="selected-files">
                                        </div>
                                        <div class="file-preview box sm">
                                        </div>
                                        <small class="text-muted">{{translate('These images are visible in product details page gallery. Use 600x600 sizes images.')}}</small>
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span style="font-weight: bold;margin-top:10px;font-size:18px;" id="customer_price">{{ $product->unit_price + get_product_commission() + get_product_vat()}}</span>
                                    </div>
                                </div>
                    ...
                    <div class="mt-4 text-right">
                        <button type="button" onclick="submitFormWithTab()" name="button" class="mx-2 btn btn-primary w-230px btn-md rounded-2 fs-14 fw-700 shadow-success action-btn">{{ translate('Update') }}</button>
                    </div>
