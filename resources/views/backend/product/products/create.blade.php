...
<div class="row">
    <div class="col-xl-12 col-lg-6 col-12">
        <x-form-card title="{{ translate('Add New Product') }}">
            <div class="d-sm-flex">
                <!-- page side nav -->
                <div class="page-side-nav c-scrollbar-light">
                ...
                <!-- tab content -->
                <div class="flex-grow-1 p-sm-3 p-lg-2rem pt-0" style="padding-top: 0 !important;">
                    <!-- Error Meassages -->
                    @if ($errors->any())
                    ...
                    <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" enctype="multipart/form-data" id="choice_form">
                        ...
                        <div class="tab-content">
                                                        ...
                                                        <h6 class="float-right fs-13 mb-0">
                                                            ...
                                                            <span class="position-relative main-category-info-icon">
                                                                ...
                                                                <span class="main-category-info bg-soft-info p-2 position-absolute d-none border">
                                                                    {{ translate('This will be used for commission-based calculations and homepage category-wise product display.') }}
                                                                </span>
                                                            </span>
                                                        </h6>
                                                    </div>
                                                        ...
                                                        <select class="form-control" name="category_id">
                                                            ...
                                                            @foreach ($categories as $category)
                                                                ...
                                                                @foreach ($category->childrenCategories as $childCategory)
                                                                    @include('backend.product.products.child_category_dropdown', ['child_category' => $childCategory, 'prefix' => '-'])
                                                                @endforeach
                                                            @endforeach
                                                        </select>
                                                    </div>
                            ...
                            <div class="tab-pane fade" id="files_and_media" role="tabpanel" aria-labelledby="files-and-media-tab">
                                <div class="bg-white p-3 p-sm-2rem">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Specification Images')}} <small>(600x600)</small></label>
                                            <div class="col-md-9">
                                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                                    ...
                                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                    <input type="hidden" name="specification_images" class="selected-files">
                                                </div>
                                                <div class="file-preview box sm">
                                                </div>
                                                <small class="text-muted">{{translate('These images are visible in product details page gallery. Use 600x600 sizes images.')}}</small>
                                ...
                                <div class="bg-white p-3 p-sm-2rem">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Unit price') }}" id="unit_price" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror">
                                                <span style="font-weight: bold;margin-top:10px;font-size:18px;">{{ translate('The price that will be shown to the customer') }}</span>
                                                <span style="font-weight: bold;margin-top:10px;font-size:18px;" id="customer_price">0</span>
                                            </div>
                                        </div>
                                        <!-- Discount Date Range -->
                                        {{-- <div class="form-group row">
                            ...
                            <div class="mt-4 text-right">
                                ...
                                <button type="submit" name="button" value="publish" class="mx-2 btn btn-primary w-230px btn-md rounded-2 fs-14 fw-700 shadow-primary action-btn">{{ translate('Save & Publish') }}</button>
                            </div>
...
@section('modal')
    ...
    @include('backend.layouts.components.modals.product_select_modal')
@endsection
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var product_commission = parseInt('{{ get_product_commission() }}');
        var product_vat = parseInt('{{ get_product_vat() }}');
        
        $('#unit_price').on('input', function() {
            var unitPrice = parseInt($(this).val());
            if (unitPrice > 0) {
                var customerPrice = unitPrice + product_commission + product_vat;
                $('#customer_price').text(customerPrice);
            } else {
                $('#customer_price').text(0);
            }
        });
    });
