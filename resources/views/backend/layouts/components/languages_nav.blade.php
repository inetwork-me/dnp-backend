...
<li class="i18n-dropdown dropdown nav-item mr-2" id="lang-change">
    <a class="nav-link d-flex align-items-center dropdown-toggle dropdown-language" id="dropdown-flag" href="javascript:;"
        data-toggle="dropdown"><img class="langimg selected-flag" src="{{ static_asset('assets/img/flags/' . $locale . '.png') }}"
