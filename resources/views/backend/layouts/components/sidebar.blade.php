          ...
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="has-sub nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li><a href="vendors_grid.php"><i class="ft-arrow-right submenu-icon"></i><span class="menu-item" data-i18n="Basic">Vendors Grid</span></a></li>
                    </li>
                </ul>
            </li>
            ...
            <li class="has-sub nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li><a href="add_admin.php"><i class="ft-arrow-right submenu-icon"></i><span class="menu-item" data-i18n="Basic">Add Admin</span></a></li>
                    </li>
                </ul>
            </li>
            <li><a href="page1.html">
