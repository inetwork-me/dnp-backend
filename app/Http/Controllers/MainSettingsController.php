...
class MainSettingsController extends Controller
{
    ...
    {
        return view('backend.settings.activation');
    }
    ...
    {
        return view('backend.settings.google_configuration.google_analytics');
    }

    public function google_recaptcha(Request $request)
    {
        return view('backend.settings.google_configuration.google_recaptcha');
    }

    public function google_map(Request $request)
    {
        return view('backend.settings.google_configuration.google_map');
    }

    public function google_firebase(Request $request)
    {
        return view('backend.settings.google_configuration.google_firebase');
    }

    public function facebook_chat(Request $request)
    {
        return view('backend.settings.facebook_chat');
    }

    public function facebook_comment(Request $request)
    {
        return view('backend.settings.facebook_configuration.facebook_comment');
    }

    public function payment_method(Request $request)
    {
        $payment_methods = PaymentMethod::whereNull('addon_identifier')->get();
        return view('backend.settings.payment_method.index', compact('payment_methods'));
    }
    ...
    {
        return view('backend.settings.order_configuration.index');
    }
