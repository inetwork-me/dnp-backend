...
Route::group(['prefix' => 'v1', 'middleware' => ['app_language']], function () {
    ...
    // Cart ownership transfer (guest → user on login)
    Route::post('cart/transfer-ownership', [WebsiteCartController::class, 'transferOwnership']);
    // NEW coupon routes
    ...
    Route::get('orders/public/{order}', [WebsiteOrderController::class, 'showPublic']); // Public endpoint for payment page
